...
const AboutContent = () => {
  return (
    <div className="flex w-[500rem] h-[250rem] bg-[url('/wheat-field.jpg')] bg-cover bg-center">
      <div aria-label="about-left" className="flex flex-col w-1/2 justify-center bg-white/65 p-[20rem]">
      ...
      >
        <div aria-label="skills" className="bg-white/75 p-[10rem] rounded-[10rem] w-[65%]">
